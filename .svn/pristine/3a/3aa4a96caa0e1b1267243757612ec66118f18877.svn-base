...
class Barcode {
    ...
    function genera_imagen($codigo, $base = 'code39') {

        $im = imagecreatetruecolor(792, 612);
        imagecopy($im, imagecreatefromjpeg('img/correo_pagado.jpg'), 0, 0, 0, 0, 792, 612);
        $black = ImageColorAllocate($im, 0x00, 0x00, 0x00);
//        $white = ImageColorAllocate($im, 0xff, 0xff, 0xff);
//        imagecolortransparent($im, $white);
//        imagefilledrectangle($im, 0, 0, 300, 150, $white);
        Barcode::gd($im, $black, 792 / 2, 557, 0, $base, $codigo, 2, 50);
    ...
    function genera_codigo($codigo, $base = 'code39') {

        $im = imagecreatetruecolor(300, 120);
        $black = ImageColorAllocate($im, 0x00, 0x00, 0x00);
        $white = ImageColorAllocate($im, 0xff, 0xff, 0xff);
        imagefilledrectangle($im, 0, 0, 300, 150, $white);
        Barcode::gd($im, $black, 150, 120 / 2, 0, $base, $codigo, 2, 50);
...
/* Location: ./aplication/libraries/Barcode.php */